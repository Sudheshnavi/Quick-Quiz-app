...
getNewQuestion = () =>{
    if(availableQuestions.length===0||questionCounter>=MAX_QESTIONS){
        return window.location.assign("end.html");
    }
    
    questionCounter++;
    progressText.innerText ="Question"+questionCounter+"/"+MAX_QESTIONS;
    //update progress bar
